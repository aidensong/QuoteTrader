...
struct Msg
{
	...
	CThostFtdcQuoteField  RtnQuote;// Quote回报
...
extern vector<pair<string, double> > Instrumentlist; //订阅合约list

extern map<string, double> InstrumentMap; //订阅合约Map

extern queue<CThostFtdcForQuoteRspField> ForQuoteRspField;//询价队列
...
extern map<string, CThostFtdcQuoteField> QuoteMap;//Q单列表
